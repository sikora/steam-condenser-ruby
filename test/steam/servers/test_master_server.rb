...
class TestMasterServer < Test::Unit::TestCase
  ...
  context 'A master server' do
    ...
    should 'be able to get a challenge' do
      ...
      socket.expects(:send).with { |packet| packet.is_a? SteamCondenser::Servers::Packets::C2M_CHECKMD5_Packet }
    ...
    should 'be able to send a heartbeat' do
      ...
      socket = @server.instance_variable_get :@socket
      socket.expects(:send).with { |packet| packet.is_a? SteamCondenser::Servers::Packets::S2M_HEARTBEAT2_Packet }
