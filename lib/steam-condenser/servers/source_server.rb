...
module SteamCondenser
  ...
  module Servers
    ...
    #
    # A Source game server is an instance of the Source Dedicated Server
    # (SrcDS) running games using Valve's Source engine, like Counter-Strike:
    # Source, Team Fortress 2 or Left4Dead.
    #
