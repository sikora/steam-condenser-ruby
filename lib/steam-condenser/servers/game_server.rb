...
module SteamCondenser
  ...
  module Servers
    ...
    module GameServer
      ...
      # @return [Hash<Symbol, String>] The attributes with the corresponding
      ...
      # this list regularly by calling {#update_players} if you rely on this
      # information.
      #
      # @param [String] rcon_password The RCON password of this server may be
      #        provided to gather more detailed information on the players,
      #        like STEAM_IDs.
      ...
      # players join or leave. As the latter changes can be monitored by
      # calling {#update_players}, there's no need to call
      # {#update_server_info} very often.
      #
      ...
      # @param [Boolean] repeat_on_failure Whether the request should be
      #        repeated, if the replied packet isn't expected. This is useful
      #        to handle missing challenge numbers, which will be automatically
      #        filled in, although not requested explicitly.
      ...
      # The server information usually only changes on map change and when
      # players join or leave. As the latter changes can be monitored by
      # calling {#update_players}, there's no need to call this method very
      # often.
      #
      # @see #handle_response_for_request
      # @see #server_info
      ...
      # {#handle_response_for_request} will automatically get the challenge
