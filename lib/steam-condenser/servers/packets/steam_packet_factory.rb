...
require 'steam-condenser/servers/packets/m2c_isvalidmd5_packet'
require 'steam-condenser/servers/packets/m2s_requestrestart_packet'
  ...
  module SteamPacketFactory
    ...
    def self.packet_from_data(raw_data)
      ...
      case header
        ...
        when BasePacket::M2C_ISVALIDMD5_HEADER
          return M2C_ISVALIDMD5_Packet.new(data)
        when BasePacket::M2S_REQUESTRESTART_HEADER
        ...
        when BasePacket::S2A_LOGSTRING_HEADER
