...
module SteamCondenser
  ...
  module Servers
    ...
    module BaseServer
      ...
      #
      # If this method returns `true`, it indicates that all IP addresses have
      # been used, hinting at the server(s) being unreachable. An appropriate
      # action should be taken to inform the user.
      #
      # Servers with only one IP address will always cause this method to
      # return `true` and the sockets will not be reinitialized.
      #
      ...
      #
      # Any failure will cause the IP to rotate to the next IP in the server's
      # IP list and the execution will be repeated for the next IP address. If
      # the IP rotation reaches the end of the list, the error will be
      # reraised.
      #
